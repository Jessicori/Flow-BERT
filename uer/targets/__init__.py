...
from uer.targets.bert_target import BertTarget, BertDualStreamSplitMlmTarget
...
__all__ = ["BertTarget", "BertDualStreamSplitMlmTarget", "MlmTarget", "LmTarget", "BilmTarget", "AlbertTarget",
           "Seq2seqTarget", "T5Target", "ClsTarget", "PrefixlmTarget", "str2target","NspTarget"]
